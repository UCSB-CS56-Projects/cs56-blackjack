package edu.ucsb.cs56.S12.pointguard328.issue757;
import javax.swing.*;
...
public class BlackjackGui{
		...
		*/
		switch(numPlayers){
			case 1:
				...
				playerLabelS.setText("Player 1 " + winOrLose1 + ", hand value = " + game.getPlayerS().getHand().displayBestValue());
				if(!p1IsWinner)
					displayLabel.setText("Dealer wins");
				break;
			case 2:
				String winOrLose2 = p1IsWinner ? "wins" : "loses";
				playerLabelS.setText("Player 1 " + winOrLose2+ ", hand value = " + game.getPlayerS().getHand().displayBestValue());
				winOrLose2 = p2IsWinner ? "wins" : "loses";
				playerLabelE.setText("Player 2 " + winOrLose2+ ", hand value = " + game.getPlayerE().getHand().displayBestValue());
				if(!p1IsWinner && !p2IsWinner)
					displayLabel.setText("Dealer Wins");
				break;
			case 3:
				String winOrLose3 = p1IsWinner ? "wins" : "loses";
				playerLabelS.setText("Player 1 " + winOrLose3+ ", hand value = " + game.getPlayerS().getHand().displayBestValue());
				winOrLose3 = p2IsWinner ? "wins" : "loses";
				playerLabelE.setText("Player 2 " + winOrLose3+ ", hand value = " + game.getPlayerE().getHand().displayBestValue());
				winOrLose3 = p3IsWinner ? "wins" : "loses";
				playerLabelW.setText("Player 3 " + winOrLose3+ ", hand value = " + game.getPlayerW().getHand().displayBestValue());
	...
	public void go(){
		...
		//initialize dealer's label and display cards, one face down
		...
		//setup all player panels with cards showing
		...
		if(keepRunning == true){
			...
			displayLabel.setText("New Round, Player 1's turn");
	...
	public void nextPlayersTurn(){
		playerTurn++;
		displayLabel.setText("Player " + playerTurn + "'s turn");
	}
